    ...
    cosmos.vesting = (function () {
        ...
        vesting.v1beta1 = (function () {
            ...
            v1beta1.Msg = (function () {
                ...
                Object.defineProperty(
                    (Msg.prototype.createVestingAccount = function createVestingAccount(request, callback) {
                        return this.rpcCall(
                            createVestingAccount,
                            $root.cosmos.vesting.v1beta1.MsgCreateVestingAccount,
                            $root.cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse,
                            request,
                            callback,
                        );
                    }),
                    'name',
                    { value: 'CreateVestingAccount' },
                );
                return Msg;
            })();
            v1beta1.MsgCreateVestingAccount = (function () {
                ...
                MsgCreateVestingAccount.encode = function encode(m, w) {
                    ...
                    if (m.delayed != null && Object.hasOwnProperty.call(m, 'delayed')) w.uint32(40).bool(m.delayed);
                    return w;
                };
                MsgCreateVestingAccount.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.MsgCreateVestingAccount();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
            ...
            v1beta1.MsgCreateVestingAccountResponse = (function () {
                ...
                MsgCreateVestingAccountResponse.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            default:
            ...
            v1beta1.BaseVestingAccount = (function () {
                ...
                BaseVestingAccount.encode = function encode(m, w) {
                    ...
                    if (m.originalVesting != null && m.originalVesting.length) {
                        for (var i = 0; i < m.originalVesting.length; ++i)
                            $root.cosmos.base.v1beta1.Coin.encode(m.originalVesting[i], w.uint32(18).fork()).ldelim();
                    }
                    if (m.delegatedFree != null && m.delegatedFree.length) {
                        for (var i = 0; i < m.delegatedFree.length; ++i)
                            $root.cosmos.base.v1beta1.Coin.encode(m.delegatedFree[i], w.uint32(26).fork()).ldelim();
                    }
                    if (m.delegatedVesting != null && m.delegatedVesting.length) {
                        for (var i = 0; i < m.delegatedVesting.length; ++i)
                            $root.cosmos.base.v1beta1.Coin.encode(m.delegatedVesting[i], w.uint32(34).fork()).ldelim();
                    }
                ...
                BaseVestingAccount.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.BaseVestingAccount();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
                                ...
                                break;
                            case 2:
                                if (!(m.originalVesting && m.originalVesting.length)) m.originalVesting = [];
                                m.originalVesting.push($root.cosmos.base.v1beta1.Coin.decode(r, r.uint32()));
                                break;
                            case 3:
                                if (!(m.delegatedFree && m.delegatedFree.length)) m.delegatedFree = [];
                                m.delegatedFree.push($root.cosmos.base.v1beta1.Coin.decode(r, r.uint32()));
                                break;
                            case 4:
                                if (!(m.delegatedVesting && m.delegatedVesting.length)) m.delegatedVesting = [];
                                m.delegatedVesting.push($root.cosmos.base.v1beta1.Coin.decode(r, r.uint32()));
                                break;
                            case 5:
                                m.endTime = r.int64();
                                break;
            ...
            v1beta1.ContinuousVestingAccount = (function () {
                ...
                ContinuousVestingAccount.encode = function encode(m, w) {
                    ...
                    if (m.baseVestingAccount != null && Object.hasOwnProperty.call(m, 'baseVestingAccount'))
                        $root.cosmos.vesting.v1beta1.BaseVestingAccount.encode(
                ...
                ContinuousVestingAccount.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.ContinuousVestingAccount();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
                                m.baseVestingAccount = $root.cosmos.vesting.v1beta1.BaseVestingAccount.decode(
                                    r,
                                    r.uint32(),
                                );
                                break;
            ...
            v1beta1.DelayedVestingAccount = (function () {
                ...
                DelayedVestingAccount.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.DelayedVestingAccount();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
            ...
            v1beta1.Period = (function () {
                ...
                Period.encode = function encode(m, w) {
                    if (!w) w = $Writer.create();
                    if (m.length != null && Object.hasOwnProperty.call(m, 'length')) w.uint32(8).int64(m.length);
                    if (m.amount != null && m.amount.length) {
                        for (var i = 0; i < m.amount.length; ++i)
                ...
                Period.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.Period();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
            ...
            v1beta1.PeriodicVestingAccount = (function () {
                ...
                PeriodicVestingAccount.encode = function encode(m, w) {
                    ...
                    if (m.vestingPeriods != null && m.vestingPeriods.length) {
                        for (var i = 0; i < m.vestingPeriods.length; ++i)
                            $root.cosmos.vesting.v1beta1.Period.encode(
                                m.vestingPeriods[i],
                                w.uint32(26).fork(),
                            ).ldelim();
                    }
                ...
                PeriodicVestingAccount.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.PeriodicVestingAccount();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                if (!(m.vestingPeriods && m.vestingPeriods.length)) m.vestingPeriods = [];
                                m.vestingPeriods.push($root.cosmos.vesting.v1beta1.Period.decode(r, r.uint32()));
                                break;
                            default:
                                r.skipType(t & 7);
                                break;
            ...
            v1beta1.PermanentLockedAccount = (function () {
                function PermanentLockedAccount(p) {
                    if (p)
                        for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                            if (p[ks[i]] != null) this[ks[i]] = p[ks[i]];
                }
                PermanentLockedAccount.prototype.baseVestingAccount = null;
                PermanentLockedAccount.create = function create(properties) {
                    return new PermanentLockedAccount(properties);
                };
                PermanentLockedAccount.encode = function encode(m, w) {
                    if (!w) w = $Writer.create();
                    if (m.baseVestingAccount != null && Object.hasOwnProperty.call(m, 'baseVestingAccount'))
                        $root.cosmos.vesting.v1beta1.BaseVestingAccount.encode(
                            m.baseVestingAccount,
                ...
                PermanentLockedAccount.decode = function decode(r, l) {
                    if (!(r instanceof $Reader)) r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l,
                        m = new $root.cosmos.vesting.v1beta1.PermanentLockedAccount();
                    while (r.pos < c) {
                        var t = r.uint32();
                        switch (t >>> 3) {
                            case 1:
