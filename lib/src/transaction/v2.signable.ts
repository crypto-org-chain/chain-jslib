...
/**
 * SignableTransactionV2 is a prepared transaction ready to be signed
 */
export class SignableTransactionV2 {
    private txRaw: TxRaw;
    ...
    /**
     * Constructor to create a SignableTransactionV2
     * @param {SignableTransactionV2Params} params
     * @returns {SignableTransactionV2}
     * @throws {Error} when params is invalid or the transaction
     */
    public constructor(params: SignableTransactionV2Params) {
        ow(params, 'params', owSignableTransactionParamsV2);
        ...
        if (
            ...
            throw new Error(
                "SignableTransactionV2 doesn't support 'nonCriticalExtensionOptions' or 'extensionOptions'",
            );
        }
        ...
        cosmosSignerInfos.forEach((signerInfo) => {
            ...
            if (!signerInfo.mode_info.single) {
                throw new Error('SignableTransactionV2 only supports single signer mode.');
            }
        ...
        const authInfoBytes = protoEncodeAuthInfoV2(authInfo);
     ...
     * @memberof SignableTransactionV2
     */
     ...
     * @memberof SignableTransactionV2
     */
    public setSignerAccountNumberAtIndex(index: number, accountNumber: Big): SignableTransactionV2 {
     ...
     * @memberof SignableTransactionV2
     */
    public setSignature(index: number, signature: Bytes): SignableTransactionV2 {
        ow(index, 'index', this.owIndex());
    ...
    public toCosmosJSON(): string {
        ...
        try {
            ...
            throw new Error('Error converting SignableTransactionV2 to Cosmos compatible JSON.');
        }
    }
}

export type SignableTransactionV2Params = {
    rawTxJSON: string;
