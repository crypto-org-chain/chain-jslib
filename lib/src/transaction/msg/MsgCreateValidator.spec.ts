...
describe('Testing MsgCreateValidator', function () {
    fuzzyDescribe('should throw Error when options is invalid', function (fuzzy) {
        ...
        testRunner(function (options) {
            ...
            expect(() => new cro.bank.MsgCreateValidator(options.value)).to.throw('Expected `options` to be of type `object`');
        });
    });
    ...
    it('Should validate MsgCreateValidator provided addresses with network config', function () {
        ...
        expect(() => new cro.bank.MsgCreateValidator(params1)).to.throw('Provided keys does not belong to same network');
        expect(() => new cro.bank.MsgCreateValidator(params2)).to.throw('Provided keys does not belong to same network');
