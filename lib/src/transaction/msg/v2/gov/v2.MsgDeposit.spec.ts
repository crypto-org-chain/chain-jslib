...
describe('Testing MsgDeposit', function () {
    ...
    describe('fromCosmosJSON', function () {
        it('should throw Error if the JSON is not a MsgDeposit', function () {
            ...
            expect(() => cro.v2.gov.MsgDepositV2.fromCosmosMsgJSON(json)).to.throw(
        ...
        it('should throw Error when the `proposal_id` field is missing', function () {
            ...
            expect(() => cro.v2.gov.MsgDepositV2.fromCosmosMsgJSON(json)).to.throw('Invalid `proposal_id` in JSON.');
        });
        ...
        it('should throw Error when the `amount` field is missing', function () {
            ...
            expect(() => cro.v2.gov.MsgDepositV2.fromCosmosMsgJSON(json)).to.throw('Invalid amount in the Msg.');
        });
        it('should return the MsgDeposit corresponding to the JSON', function () {
            ...
            const MsgDeposit = cro.v2.gov.MsgDepositV2.fromCosmosMsgJSON(json);
