...
export const ANY_VALID_PRIV_KEY = Bytes.fromUint8Array(new Uint8Array(32).fill(1));

export const ANY_INVALID_PRIV_KEY = Bytes.fromUint8Array(new Uint8Array(32).fill(0));
...
export const ANY_VALID_KEY_PAIR: {
    ...
    privKey: Bytes.fromUint8Array(new Uint8Array(32).fill(1)),
    pubKey: (() => {
