    ...
    describe('constructor', function () {
        ...
        context('When unit is base unit', function () {
            it('should throw Error when the provided string is not a valid number', function () {
                expect(() => new cro.v2.CoinV2('invalid', cro.Coin.UNIT_BASE)).to.throw(
            ...
            it('should throw Error when the provided string is a floating number', function () {
                expect(() => new cro.v2.CoinV2('1234.5678', cro.Coin.UNIT_BASE)).to.throw(
                    'Expected base amount to be an integer',
                );
            });

            it('should throw Error when the provided string is not a base10 number', function () {
                expect(() => new cro.v2.CoinV2('0xff', cro.Coin.UNIT_BASE)).to.throw(
                    'Expected amount to be a base10 number represented as string',
                );
            });

            it('should throw Error when the provided string is a negative integer', function () {
                expect(() => new cro.v2.CoinV2('-1000', cro.Coin.UNIT_BASE)).to.throw('Expected base amount to be positive');
            });

            it('should throw Error if the value exceed total supply', function () {
                expect(() => new cro.v2.CoinV2('10000000000000000001', cro.Coin.UNIT_BASE)).to.throw(
            ...
            it('should return a coins object of the provided string', function () {
                ...
                const coins = new cro.v2.CoinV2(anyBaseValue, cro.Coin.UNIT_BASE);
        ...
        context('When unit is CRO', function () {
            it('should throw Error when the provided string is not a valid number', function () {
                expect(() => new cro.v2.CoinV2('invalid', cro.Coin.UNIT_CRO)).to.throw(
                    'Expected amount to be a base10 number represented as string',
                );
            });

            it('should throw Error when the provided string is not a base10 number', function () {
                expect(() => new cro.v2.CoinV2('0xff', cro.Coin.UNIT_CRO)).to.throw(
                    'Expected amount to be a base10 number represented as string',
                );
            });

            it('should throw Error when the provided string is a negative integer', function () {
                expect(() => new cro.v2.CoinV2('-1000', cro.Coin.UNIT_CRO)).to.throw('Expected CRO amount to be positive');
            });

            it('should throw Error when the provided string exceed 8 decimal places', function () {
                expect(() => new cro.v2.CoinV2('1000.123456789', cro.Coin.UNIT_CRO)).to.throw(
                    'Expected CRO amount to have at most 8 decimal places',
                );
            });

            it('should throw Error if the value exceed total supply', function () {
                expect(() => new cro.v2.CoinV2('100000000001', cro.Coin.UNIT_CRO)).to.throw(
            ...
            it('should return a coins object of the provided string', function () {
                ...
                const coins = new cro.v2.CoinV2(anyCROValue, cro.Coin.UNIT_CRO);
        ...
        context('When `denom` is passed along other params', function () {
            it('should throw Error when the provided `units` and `denom` do not belong to same network', function () {
                expect(() => new cro.v2.CoinV2('1000000', cro.Coin.UNIT_CRO, 'cosmos')).to.throw(
                    'Provided Units and Denom do not belong to the same network.',
                );
            });
            it('should set the `denom` correctly', function () {
                expect(() => new cro.v2.CoinV2('1000000', cro.Coin.UNIT_BASE, 'cosmos')).to.not.throw();

                const coin = new cro.v2.CoinV2('1000000', cro.Coin.UNIT_BASE, 'cosmos');
            ...
            it('should return `baseAmount` correctly on same network `unit` & `denom`', function () {
                expect(() => new cro.v2.CoinV2('1000000', cro.Coin.UNIT_CRO, 'cro')).to.not.throw();
                expect(() => new cro.v2.CoinV2('1000000', cro.Coin.UNIT_CRO, 'tcro')).to.not.throw();

                const CROcoin = new cro.v2.CoinV2('11111111', cro.Coin.UNIT_CRO, 'cro');
                const TCROcoin = new cro.v2.CoinV2('22222222', cro.Coin.UNIT_CRO, 'tcro');
