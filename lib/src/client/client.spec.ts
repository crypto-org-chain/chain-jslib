...
const statusQueryResponse = {
    ...
    "result": {
        "response": {
            ...
            "index": "0",
            "key": null,
            "value": "CqABCiAvY29zbW9zLmF1dGgudjFiZXRhMS5CYXNlQWNjb3VudBJ8Cit0Y3JvMW16NXJkdGY5d3Vmd2toOHRlMnp3dzd0d3RtbmE2cmhsMnFsaGxjEkYKHy9jb3Ntb3MuY3J5cHRvLnNlY3AyNTZrMS5QdWJLZXkSIwohAob4I2sjPo331LScKWdPIyotGEKG9ZGRFD/xPUBIzDBtGOICIMiCJQ==",
            "proofOps": null,
            "height": "1825383",
            "codespace": ""
        }
    ...
    describe('connect', function () {
        ...
        context('Getting On-Chain details', function () {
            it('Should fetch correct details from the network', async function () {
                ...
                nock(CroNetwork.Testnet.rpcUrl)
                    .persist(true)
                    .post('/')
                    .reply(200, statusQueryResponse)
